...
def get_couch_config() -> dict:
    # Prefer backend-specific vars; fall back to NEXT_PUBLIC_* if provided
    couch_url = (
...
def validate_db_name(db_name: str) -> None:
    # CouchDB: lowercase letters (a-z), digits (0-9), and _$()+-/ characters
